...
if __name__ == "__main__":
    ...
    npz_file_path = "/home/robotlab/work/semantic-segmentation-pytorch/save_results/temp/episode_part_000.npz"
    # npz_file_path = "/home/robotlab/dataset/semantic/semantic_datasets/data_slam/test/1/ruihai_livingroom.npz"
    npz_file_path = "/home/robotlab/work/semantic-segmentation-pytorch/save_results/temp/episode_part_045.npz"
    ...
    step=1 #表示从 0 开始，每次增加 10
    for t in range(0, len(dataset), step):
        print(f"🕒 时间步 {t}")
        item = dataset[t]
