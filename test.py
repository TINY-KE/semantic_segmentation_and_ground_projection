...
color_mapping_27 = {
    ...
    9:  (128, 0, 0),       # 栗色 / 深红色 maroon
    10: (255, 20, 147),    # 粉色 pink / 深粉红 deep pink
    11: (0, 128, 0),       # 深绿色 dark green
    12: (128, 0, 128),     # 紫色 purple
    13: (0, 128, 128),     # 水鸭色 teal
    14: (0, 0, 128),       # 藏青色（深蓝） navy
...
def visualize_result_old(data, pred, cfg):
    (img, info) = data
